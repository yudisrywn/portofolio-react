...
export const CodeLine = ({ children, indent = 0 }: CodeLineProps) => {
  return (
    <div className="hover:bg-vscode-border/30 transition-colors" style={{ paddingLeft: `${indent * 1}rem` }}>
      {children}
    </div>
  );
};

export const Keyword = ({ children, className }: { children: ReactNode; className?: string }) => (
  <span className={className || "text-syntax-purple"}>{children}</span>
);

export const Function = ({ children, className }: { children: ReactNode; className?: string }) => (
  <span className={className || "text-syntax-yellow"}>{children}</span>
);

export const String = ({ children, className }: { children: ReactNode; className?: string }) => (
...
export const Variable = ({ children, className }: { children: ReactNode; className?: string }) => (
  <span className={className || "text-syntax-cyan"}>{children}</span>
);

export const Type = ({ children, className }: { children: ReactNode; className?: string }) => (
  <span className={className || "text-syntax-blue"}>{children}</span>
);

export const Property = ({ children, className }: { children: ReactNode; className?: string }) => (
