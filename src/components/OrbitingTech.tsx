...
type GlowColor = "white" | "semiwhite";
  ...
  ({
    ...
    const glowColors = {
      white: {
        ...
        secondary: "rgba(200, 200, 200, 0.2)",
    ...
    const colors = glowColors[glowColor] || glowColors.white;
...
export default function OrbitingSkills() {
  ...
  const orbitConfigs: Array<{
    ...
    { radius: 180, glowColor: "semiwhite", delay: 1.5 },
  ];
